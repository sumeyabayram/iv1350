...
public class View {
     ...
     */
    public void runFakeExecution() throws InvalidIdentifierException, DatabaseFailureException {
     ...
     * @throws DatabaseFailureException 
     */
    private void scanItem() throws InvalidIdentifierException, DatabaseFailureException {
        try {
